...
const BLOG = {
  ...
  SINCE: process.env.NEXT_PUBLIC_SINCE || 2050, // e.g if leave this empty, current year will be used.
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'NekoMirra', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '高性能一体机/正在努力成为全栈开发者/设计师/AI恋', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'MirraDev.eu.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,NekoMirra,AI', // 网站关键词 英文逗号隔开
